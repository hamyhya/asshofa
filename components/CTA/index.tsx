...
const CTA = () => {
  return (
    <>
      {/* <!-- ===== CTA Start ===== --> */}
      <section id="sukarelawan" className="overflow-hidden px-4 py-20 md:px-8 lg:py-25 xl:py-30 2xl:px-0">
          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Bergabung Menjadi Sukarelawan
              </h2>
              <p>
                Mari bergabung dengan kami dan mulai memberikan dampak bagi sesama
              </p>
            </motion.div>
            <motion.div
              variants={{
            ...
            >
              <div className="flex items-center justify-end xl:justify-between">
                ...
                />
                <a
                  href="https://wa.me/6289648619465"
